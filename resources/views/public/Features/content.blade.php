				...
				<div id="im-accordion-content">
					...
					{{-- Finances --}}
						<div class="im-accordion">
							...
							<p>iMedical outlines how a Practice should approach charging for its services (Private, Corporate and State Contracts) and provides an easy-access overview of the GMS claim structure and process, including details the Under 6s and also Special Services. Relevant checklists make tasks easy to complete and bring consistency to financial management. </p>
						</div>
					...
					{{-- Human Resources --}}
						<div class="im-accordion">
							...
							<p>iMedical provides a range of information around staff recruitment and management including policies and procedures covering staff joining, moving within or leaving your Practice, code of conduct, staff grievances, bullying and harassment, disciplinary processes, continuing professional development and internet and social media usage. </p>
					...
					{{-- Health & Safety --}}
						<div class="im-accordion">
							...
							<p>Safe practice involves taking a proactive approach toward the safety of Practice staff and patients. In a fast-paced medical workplace this must involve appropriate supervision of less experienced staff. It also requires easily accessible, practicable policies and procedures to be in place. A systematic approach will give better outcomes - this is the responsibility of employers, supported by all in the workplace. </p>
							<p>iMedical includes information on the general principles of Health & Safety pursuant to Irish legislation and also the recommendations of the Health and Safety Authority in Ireland. RBP comprises a detailed Practice Safety Statement which each Practice is required to have under law. Employer and employee duties care clearly set out as is the requirement for and functions of a Practice Safety Officer, including Accident Reporting. iMedical also sets out how to complete a Practice Health and Safety Risk Assessment, apply relevant controls and audit ongoing compliance. </p>
						</div>
					{{-- Emergency Planning --}}
						<div class="im-accordion">
